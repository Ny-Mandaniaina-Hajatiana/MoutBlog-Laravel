...
@yield('title')
    ...
    <link href="{{asset('bootstrap/css/blog-home.css')}}" rel="stylesheet">
    <link href="{{asset('bootstrap/css/css/blog-post.css')}}" rel="stylesheet">
</head>
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="#">Catégories
                    </a>
                </li>
            </ul>
        </div>
